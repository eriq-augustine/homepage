<?php
   ...
   $assignments_file = "cpe101-winter14-files/assignments.txt";
   $labs_file = "cpe101-winter14-files/labs.txt";

   $lecture_dir = "cpe101-winter14-files/lectures";
   $misc_dir = "cpe101-winter14-files/misc";

   $extraCSS = array('cpe101.css');
         ...
         <div id="main">
            <div class="main-content">
               ...
               <div>
                  ...
                  <div class='info-area'>
                     <h4>Style</h4>
                     <p><a href='<?php echo $webBase; ?>/cpe101-winter14-files/101-style.html'>CPE 101 Style Guide</a></p>
                  </div>
