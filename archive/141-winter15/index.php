...
<div id="main" class="wide">
   <div class="main-content">
      ...
      <div>
         ...
         <p><a href='<?php echo pageLink('csc141-winter15-files/syllabus.html'); ?>'>Syllabus</a></p>
         <p>Schedule:</p>
         <?php
      ...
      <div>
         ...
         <div class='info-area'>
            <p><a href='<?php echo pageLink('csc141-winter15-files/141w2015_midterm2_key.pdf'); ?>'>Midterm 2 Key</a></p>
         </div>

         <div class='info-area'>
            <h4>Textbook Materials</h4>
            <p><a href='<?php echo pageLink('csc141-winter15-files/LogicalEquivalenciesToKnow.pdf'); ?>'>Logical Equivalencies To Know</a></p>
            <p><a href='<?php echo pageLink('csc141-winter15-files/Chapter8_7th_Edition_Rosen.pdf'); ?>'>Chaper 8 from 7th Edition</a></p>
         </div>
