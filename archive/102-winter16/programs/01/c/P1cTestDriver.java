 ...
 * @author Kurt Mammen
 *
 * 10/21/2014 Fixed test for equals to verify denominator too - old tests just
 *            happened to use test values that had the same denominator so it
 *            did not catch cases where equals method did not check denominator.
...
public class P1cTestDriver
{
   ...
   private static boolean testEquals()
   {
      ...
      pass &= test(!f2.equals(f4), "equals() is true, expected false");
