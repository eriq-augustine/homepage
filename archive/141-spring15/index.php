...
<div id="main" class="wide">
   <div class="main-content">
      <h2 class='page-title'>CSC 141 Spring 2015</h2>
      <p>This is the official page for CPE 141 Spring 2015.</p>
      <hr />
      ...
      <div>
         ...
         <p><a href='<?php echo pageLink('csc141-spring15-files/syllabus.html'); ?>'>Syllabus</a></p>
         <p>Schedule:</p>
         <?php
      ...
      <div>
         ...
         <div class='info-area'>
            ...
            <p><a href='<?php echo pageLink('csc141-spring15-files/LogicalEquivalenciesToKnow.pdf'); ?>'>Logical Equivalencies To Know</a></p>
            <p><a href='<?php echo pageLink('csc141-spring15-files/Chapter8_7th_Edition_Rosen.pdf'); ?>'>Chaper 8 from 7th Edition</a></p>
         </div>
