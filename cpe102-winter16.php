         ...
         <div id="main" class="wide">
            <div class="main-content">
               ...
               <div>
                  ...
                  <p><a href='<?php echo $webBase; ?>/cpe102-winter16-files/syllabus.html'>Syllabus</a></p>
                  <p>Schedule:</p>
                  <?php
                     // https://docs.google.com/spreadsheets/d/1kvWE6yQ16EUGBJBLiC4-yMT0mNxadIBnqKp31JWyssI/pubhtml?gid=0&single=true
                  ?>
                  <iframe width='1010' height='300' frameborder='0' src="https://docs.google.com/spreadsheets/d/1kvWE6yQ16EUGBJBLiC4-yMT0mNxadIBnqKp31JWyssI/pubhtml?widget=true&amp;headers=false"></iframe>
               </div>
               <hr />
               ...
               <div>
                  ...
                  <div class='info-area'>
                     ...
                     <p>
                        Your second resource (and one of the best options throughout your computer science career at Cal Poly) is our <a href='<?php echo $webBase; ?>/csc102-winter16-files/tutoring'>Tutoring Center</a>.
                     ...
                     <p><a href='<?php echo $webBase; ?>/csc102-winter16-files/tutoring'>Tutoring Center Resource</a></p>
                  </div>
